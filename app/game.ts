...
export const characters: Character[] = [
  { id: "bart", name: "Bart Cassidy", life: 8, ability: "Có thể lấy 1 mũi tên thay cho mỗi sát thương do bắn hoặc Gatling." },
  ...
  { id: "el-gringo", name: "El Gringo", life: 7, ability: "Người làm bạn mất máu do bắn hoặc Gatling phải lấy 1 mũi tên." },
  { id: "jesse", name: "Jesse Jones", life: 9, ability: "Khi còn tối đa 4 máu, Bia dùng cho bản thân hồi 2 máu." },
  { id: "jourdonnais", name: "Jourdonnais", life: 7, ability: "Chỉ mất tối đa 1 máu trong mỗi đợt tấn công của thổ dân." },
  { id: "kit", name: "Kit Carlson", life: 7, ability: "Mỗi Gatling bỏ được 1 mũi tên của bất kỳ người chơi nào." },
  { id: "lucky", name: "Lucky Duke", life: 8, ability: "Được tung xúc xắc tối đa 4 lần mỗi lượt." },
  { id: "paul", name: "Paul Regret", life: 9, ability: "Không mất máu bởi Gatling." },
  { id: "pedro", name: "Pedro Ramirez", life: 8, ability: "Mỗi lần mất máu, có thể bỏ cùng số mũi tên của mình." },
  { id: "rose", name: "Rose Doolan", life: 9, ability: "Tầm 1 và Tầm 2 có thể bắn xa hơn 1 vị trí." },
  { id: "sid", name: "Sid Ketchum", life: 8, ability: "Đầu lượt, hồi 1 máu cho một người chơi." },
  { id: "slab", name: "Slab the Killer", life: 8, ability: "Một lần mỗi lượt, đổi 1 Bia để tăng một phát bắn lên 2 sát thương." },
